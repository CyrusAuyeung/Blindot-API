...
if grep -RInE "blindot\.org|104\.248|Cyrus|Ouyang|noreply@blindot|support@blindot|BEGIN .*PRIVATE KEY|sk-|ghp_|xkeysib-" . --exclude-dir=.git --exclude=check-public-safe.sh; then
